        ...
        <div class="card-body ps-3 pe-3 pb-3 pt-3">
            <form method="POST" action="{{ route('webmail.sendReply', ['originalMessage' => $message->getUid()]) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="toEmail" id="toEmail" class="form-control" value="" required>
                </div>

                <div class="form-group">
                    <label for="subject">Subject</label>
                    <input type="text" name="subject" id="subject" class="form-control" value="Fw: {{ $message->subject }}" required>
                </div>
